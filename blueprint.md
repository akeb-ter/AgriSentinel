...
* **Edge Machine Learning:** Edge Impulse FOMO Model optimized for lightweight vision detection[cite: 1].
* **Backend Framework:** FastAPI (Python) serving REST APIs and WebSocket streams over LAN[cite: 1].
* **Database Layer:** SQLite (embedded single-file database)[cite: 1].
* **Frontend GUI:** Vite + Vue.js (or HTML5 + Tailwind CSS)[cite: 1].
* **Mobile Client:** MIT App Inventor application wrapping the responsive Web Dashboard via `WebViewer`[cite: 1].
